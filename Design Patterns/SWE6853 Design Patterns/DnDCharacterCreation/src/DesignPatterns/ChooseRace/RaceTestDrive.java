// Tests Race Factory Design Pattern
package DesignPatterns.ChooseRace;

import DesignPatterns.ChooseRace.Dragonborn.DragonbornRace;
import DesignPatterns.ChooseRace.Dwarf.DwarfRace;

import java.util.Scanner;

public class RaceTestDrive {
    ...
    private static void raceSelection(char selection) {
        if (selection == 1) {
            ...
            Race race = dwarf.chooseSubrace(subrace);
        }
        else if (selection == 2) {
